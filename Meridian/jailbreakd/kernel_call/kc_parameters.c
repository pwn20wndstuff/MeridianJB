...
addresses__iphone11_2__16A366() {
    ADDRESS(paciza_pointer__l2tp_domain_module_start)       = offset_paciza_pointer__l2tp_domain_module_start;
    ADDRESS(paciza_pointer__l2tp_domain_module_stop)        = offset_paciza_pointer__l2tp_domain_module_stop;
    ADDRESS(l2tp_domain_inited)                             = offset_l2tp_domain_inited;
    ADDRESS(sysctl__net_ppp_l2tp)                           = offset_sysctl__net_ppp_l2tp;
    ADDRESS(sysctl_unregister_oid)                          = offset_sysctl_unregister_oid;
    ADDRESS(mov_x0_x4__br_x5)                               = offset_mov_x0_x4__br_x5;
    ADDRESS(mov_x9_x0__br_x1)                               = offset_mov_x9_x0__br_x1;
    ADDRESS(mov_x10_x3__br_x6)                              = offset_mov_x10_x3__br_x6;
    ADDRESS(kernel_forge_pacia_gadget)                      = offset_kernel_forge_pacia_gadget;
    ADDRESS(kernel_forge_pacda_gadget)                      = offset_kernel_forge_pacda_gadget;
    ...
    ADDRESS(IOUserClient__vtable)                           = offset_IOUserClient__vtable;
    ADDRESS(IORegistryEntry__getRegistryEntryID)            = offset_IORegistryEntry__getRegistryEntryID;
}
